...
public class Task4 {
	...
	public static void main(String[] args) throws StreamWriteException, DatabindException, IOException {
		 File file=new File("C:\\Users\\HP\\eclipse-workspace\\ApiTesting\\src\\test\\resources\\task4.json");
		 ...
		 Support1 sup=new Support1("https://reqres.in/#support-heading", 
				 "To keep ReqRes free, contributions towards server costs are appreciated!");
   		PojoClass4 pc=new PojoClass4(2, 6, 12, 2, data, sup);
